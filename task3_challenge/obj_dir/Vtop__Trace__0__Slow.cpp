...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+7,(vlSelf->top__DOT__clock__DOT__count),16);
    bufp->fullIData(oldp+8,(vlSelf->top__DOT__fsm__DOT__current_state),32);
    bufp->fullIData(oldp+9,(vlSelf->top__DOT__fsm__DOT__next_state),32);
